...
button_equal = Button(root, text="=", padx=91, pady=20, borderwidth=5, command=button_equal)
button_clear = Button(root, text="Clear", padx=79, pady=20, borderwidth=5, command=button_clear)
